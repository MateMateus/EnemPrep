...
public interface IQuestaoService
{
    ...
    Task<Result<PagedResult<QuestaoDto>>> GetPagedByTemaAsync(Guid temaId, PagedRequest request, CancellationToken cancellationToken = default);
    Task<Result<QuestaoDto>> CriarAsync(CriarQuestaoRequest request, CancellationToken cancellationToken = default);
    Task<Result<QuestaoDto>> AtualizarAsync(Guid id, AtualizarQuestaoRequest request, CancellationToken cancellationToken = default);
